...
public class FireLanceRegisters {
	...
	public static final RegistryObject<Item> FIRE_LANCE = REGISTRY.register("fire_lance", () -> new FireLanceItem(new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_COMBAT).durability(999)));
}