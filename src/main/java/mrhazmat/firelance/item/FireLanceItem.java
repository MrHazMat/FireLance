...
package mrhazmat.firelance.item;
...
public class FireLanceItem extends Item {
	public FireLanceItem() {
		super(new Item.Properties().tab(CreativeModeTab.TAB_COMBAT).durability(999));
	}
		...
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				...
				if (entity.getAbilities().instabuild || stack != ItemStack.EMPTY) {
					FireLanceEntity entityarrow = FireLanceEntity.shoot(world, entity, world.getRandom(), 1f, 5, 5);
